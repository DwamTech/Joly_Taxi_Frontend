  ...
  return (
    <div className="general-settings">
      ...
      <div className="settings-section">
        ...
        <div className="settings-grid">
          <div className="setting-item">
            <label className="setting-label">سعر الاشتراك الشهري (جنيه)</label>
            <input
              type="number"
              className="setting-input"
          ...
          <div className="setting-item">
            <label className="setting-label">سعر الاشتراك الربع سنوي (جنيه)</label>
            <input
              type="number"
              className="setting-input"
          ...
          <div className="setting-item">
            <label className="setting-label">سعر الاشتراك السنوي (جنيه)</label>
            <input
              type="number"
              className="setting-input"
